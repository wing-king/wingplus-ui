...
// Composables
import { useEventListener, useParent } from "@wingplus-ui/use";
import { useTouch, useExpose } from "../composables";
	...
	setup(props, { emit, slots }) {
		...
		const renderOptions = () => {
			...
			return props.options.map((option, index) => {
				...
				return <li {...data}>{slots.option ? slots.option(option, index) : <div {...childData} />}</li>;
			});
		};
